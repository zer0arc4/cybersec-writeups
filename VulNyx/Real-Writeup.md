# [VulNyx](https://vulnyx.com/)  – Real Writeup

<img width="843" height="496" alt="image" src="https://github.com/user-attachments/assets/f675c056-ba59-4e50-98f7-45f1b4141afd" />

---
# Key Vulnerabilities

- UnrealIRCd 3.2.8.1 backdoor — **CVE-2010-2075**
- Root cron job executing `/opt/task`
- `/opt/task` uses the hostname `shelly.real.nyx`
- `/etc/hosts` is writable by non-root users
- Hostname resolution can therefore be redirected to the attacker's machine
- Root cron job connects to the resolved host and provides `/usr/bin/sh`
