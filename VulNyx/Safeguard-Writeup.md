# [VulNyx](https://vulnyx.com/) – Safeguard Writeup

<img width="671" height="426" alt="Safeguard" src="https://github.com/user-attachments/assets/f07ef12d-db79-4de1-ab66-14b21cee5dbc" />
...
- Apache Tomcat 10.1.34 — **CVE-2025-24813**
- Apache Tomcat partial PUT deserialization leading to RCE
- Misconfigured cron `PATH`
- PATH hijacking through the `cleanup` command
- Sudo permission on `/usr/bin/hostnamectl`
- Hostname-dependent sudo configuration
- Misconfigured `sudoers` rule allowing `/bin/bash` as root on a specific hostname
