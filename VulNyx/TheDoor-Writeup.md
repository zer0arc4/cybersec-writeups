# [VulNyx](https://vulnyx.com/) – TheDoor Writeup

<img width="847" height="496" alt="image" src="https://github.com/user-attachments/assets/855ccd9d-67b6-40d2-b139-7dfce2da2ca7" />
...
- Exposure of `dooruser` SSH private key
- `/usr/bin/python3.12` with `CAP_SETUID`
