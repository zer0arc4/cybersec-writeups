# VulNyx – Kyubi Writeup

<img width="847" height="493" alt="image" src="https://github.com/user-attachments/assets/a2769bde-25a0-45b8-a0c9-e8df18cdcc1c" />
...
* Sensitive configuration disclosure through Grafana traversal
* Redis authentication using a recovered password
* Credential disclosure through Redis
* Gitea repository Git Hook command execution
* Linux kernel privilege escalation — `CVE-2026-43503 (DirtyClone)`
...
Further vulnerability research identifies the kernel as vulnerable to:
